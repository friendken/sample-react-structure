...
import { organizationActiveSelector } from '../../providers/organizations/organizations.selector'
...
const mapPropToState = ({ organizations }) => ({
  searchText: _.get(organizations, ['orgSearch', 'active'], ''),
  organizations: organizationActiveSelector(organizations),
  organizationsLoading: organizations.organizationsLoading,
})

export default connect(mapPropToState)(OrganizationWrapper(OrganizationActive, 'active'));